  ...
  <body>
    <div class="ui inverted huge borderless fixed fluid menu">
      ...
      <div class="right menu">
        ...
        <a class="item" href="logout.php">Deconnexion</a>
      </div>
    </div>
      ...
      <div class="row">
        <div class="column" id="sidebar">
          <div class="ui secondary vertical fluid menu">
            <a class="active item" href="bookings.php">
Réservations</a><a class="item" href="transactions.php">Transactions</a><a class="item" href="travelclass.php">Classes</a><a class="item">Exporter</a>
	...
	<div class="ui grid">
            <div class="row">
         <h1 class="ui huge header">Tout les réservations</h1></div>
        <div class="ui horizontal divider">Les details de chaque réservation</div>      
		<?php 
//rejection
...
echo ("<div class='ui positive message' style='margin:auto'>Supprimé avec succès #$or.</div>");	
}	
else{
echo ("<div class='ui negative message' style='margin:auto'>Erreur!  #$or ! </div>");	
}	
}
//end of Php 
?>
...
<thead><tr><th>Reference</th><th>Nom du Client</th><th>Contact</th><th>Classe resérvé</th><th>Destination</th><th>#No places</th><th>date de voyage</th><th>Opération</th></tr></thead>
<tbody>
<?php
require("../dbengine/dbconnect.php");
...
{$order=$row['order_ref'];
echo("<tr><td>".$row['order_ref']."</td><td>".$row['fullname']."</td><td>".$row['contact']."</td><td>".$row['class_reserved']."</td><td>".$row['destination']."</td><td>".$row['seats_reserved']."</td><td>".$row['date_reserved']."</td><td><a class='ui tiny button orange' href='bookings.php?reject=$order'>Rejecter</a></td></tr>");
}		
}
else{
echo "<tr><td colspan='9'>pas de resultat ! </td></tr>";	
}
mysqli_close($conn);
?>
</tbody>
