...
Réservations</a><a class="item " href="transactions.php">Transactions</a><a class="active item" href="travelclass.php">Classes</a><a class="item">Exporter</a>
          </div>
        </div>
	...
	<div class="ui grid">
            <div class="row">
         <h1 class="ui huge header">Les Classes de voyage </h1>
         </div>
        <div class="ui horizontal divider"> Classes disponible</div>      
		<div class="row">
            <table class="ui single line striped selectable center aligned  table">
<thead><tr><th>#ID_Classe</th><th>Nom</th><th>Capacité de la classe</th><th>Prix de la classe</th><th>Description</th></tr></thead>
<tbody>
<?php
