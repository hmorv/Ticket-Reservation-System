      ...
      <div class="row">
        <div class="column" id="sidebar">
          <div class="ui secondary vertical fluid menu">
            <a class="item" href="bookings.php">
Réservations</a><a class="item active" href="transactions.php">Transactions</a><a class="item" href="travelclass.php">Classes</a><a class="item">Exporter</a>
	...
	<div class="ui grid">
            <div class="row">
         <h1 class="ui huge header">Les Transactions recu</h1>
         </div>
        <div class="ui horizontal divider"> Ce sont tous les détails des transactions</div>      
		<div class="row">
            <table class="ui single line striped selectable center aligned  table">
<thead><tr><th>Reference</th><th>Montant payé</th><th>Paiement par</th><th>code de transaction</th><th>payé par</th></tr></thead>
<tbody>
<?php
